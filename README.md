...
```sh
$ git clone https://github.com/rosanlent/Telegram_VC_Bot
$ cd Telegram_VC_Bot
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/rosanlent/Telegram_VC_Bot/tree/master)
